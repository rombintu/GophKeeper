...
func (c *keeperClient) Fetch(ctx context.Context, in *FetchRequest, opts ...grpc.CallOption) (*FetchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.keeper.Keeper/Fetch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.keeper.Keeper/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) CreateMany(ctx context.Context, in *CreateBatchRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/proto.keeper.Keeper/CreateMany", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/proto.keeper.Keeper/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Keeper_Fetch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.keeper.Keeper/Fetch",
	}
...
func _Keeper_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.keeper.Keeper/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Keeper_CreateMany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.keeper.Keeper/CreateMany",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Keeper_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.keeper.Keeper/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Keeper_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.keeper.Keeper",
